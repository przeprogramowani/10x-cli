...
- 10x-cli: 3 source modules; the centre of gravity is **`context/map`** (94 commits in window, 24 files).
...
| Area | Ask |
| --- | --- |
| `context/map` | Marcin Czarkowski (11) |
...
- `context/map/artifact-2-structure.md` — 21 commits in window
- `context/map/repo-map.md` — 21 commits in window
- `context/map/artifact-1-territory.md` — 20 commits in window
- `context/map/artifact-3-contributors.md` — 20 commits in window
