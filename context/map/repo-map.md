...
- 10x-cli: 3 source modules; the centre of gravity is **`context/map`** (82 commits in window, 24 files).
...
| Area | Ask |
| --- | --- |
| `context/map` | Marcin Czarkowski (8) |
...
- `context/map/artifact-2-structure.md` — 18 commits in window
- `context/map/repo-map.md` — 18 commits in window
- `context/map/artifact-1-territory.md` — 17 commits in window
- `context/map/artifact-3-contributors.md` — 17 commits in window
