...
- 10x-cli: 3 source modules; the centre of gravity is **`context/map`** (102 commits in window, 24 files).
...
| Area | Ask |
| --- | --- |
| `context/map` | Marcin Czarkowski (12) |
...
- `context/map/artifact-2-structure.md` — 23 commits in window
- `context/map/repo-map.md` — 23 commits in window
- `context/map/artifact-1-territory.md` — 22 commits in window
- `context/map/artifact-3-contributors.md` — 22 commits in window
