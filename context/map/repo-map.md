...
- 10x-cli: 3 source modules; the centre of gravity is **`context/map`** (78 commits in window, 24 files).
...
| Area | Ask |
| --- | --- |
| `context/map` | Marcin Czarkowski (7) |
...
- `context/map/artifact-2-structure.md` — 17 commits in window
- `context/map/repo-map.md` — 17 commits in window
- `context/map/artifact-1-territory.md` — 16 commits in window
- `context/map/artifact-3-contributors.md` — 16 commits in window
