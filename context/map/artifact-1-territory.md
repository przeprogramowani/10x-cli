...
> Scan of `ae01d7b` (2026-07-28) · window: last 12 months · engine: tools/repo-map
...
| --- | --- |
| `package.json` | 30 |
| `context/map/artifact-2-structure.md` | 23 |
| `context/map/repo-map.md` | 23 |
| `context/map/artifact-1-territory.md` | 22 |
| `context/map/artifact-3-contributors.md` | 22 |
