...
> Scan of `45e2718` (2026-07-28) · window: last 12 months · engine: tools/repo-map
...
| --- | --- |
| `package.json` | 30 |
| `context/map/artifact-2-structure.md` | 16 |
| `context/map/repo-map.md` | 16 |
| `src/commands/get.ts` | 16 |
| `context/map/artifact-1-territory.md` | 15 |
| `context/map/artifact-3-contributors.md` | 15 |
