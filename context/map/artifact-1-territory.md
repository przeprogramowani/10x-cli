...
> Scan of `e2aee50` (2026-07-27) · window: last 12 months · engine: tools/repo-map
...
| `context/map/artifact-1-territory.md` | 6 |
| `context/map/artifact-2-structure.md` | 6 |
| `context/map/artifact-3-contributors.md` | 6 |
| `context/map/graph/coupling.json` | 6 |
| `context/map/repo-map.md` | 6 |
