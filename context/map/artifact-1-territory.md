...
> Scan of `d0014dc` (2026-07-28) · window: last 12 months · engine: tools/repo-map
...
| --- | --- |
| `package.json` | 30 |
| `context/map/artifact-2-structure.md` | 18 |
| `context/map/repo-map.md` | 18 |
| `context/map/artifact-1-territory.md` | 17 |
| `context/map/artifact-3-contributors.md` | 17 |
