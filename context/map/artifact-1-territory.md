...
> Scan of `a27e2c4` (2026-07-27) · window: last 12 months · engine: tools/repo-map
...
| `CLAUDE.md` | 6 |
| `tests/doctor-command.test.ts` | 6 |
| `tests/list-command.test.ts` | 6 |
| `src/lib/api-client.ts` | 6 |
| `context/changes/e2e/plan.md` | 6 |
